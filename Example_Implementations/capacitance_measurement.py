...
#%%
time.sleep(60*15)
for humidity in np.linspace(30,45,200):
    enviornment_setpoint_time(20, humidity, 10)
set_temperature(20)
ezt.set_humidity_SP(10)
...
file_name = f'Silver Sample 1 Line 1 plate temp only_{date}'
